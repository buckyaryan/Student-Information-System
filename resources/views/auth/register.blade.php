            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('usn') ? ' has-error' : '' }}">
                            <label for="usn" class="col-md-4 control-label">USN</label>

                            <div class="col-md-6">
                                <input id="usn" type="text" class="form-control" name="usn" value="{{ old('usn') }}">
                        ...
                        <div class="form-group{{ $errors->has('semester') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="semester" type="text" class="form-control" name="semester" value="{{ old('semester') }}">
